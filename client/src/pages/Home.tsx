    ...
    <main className="min-h-screen bg-[#F3F0E9] text-[#102936] selection:bg-[#EF5D3F] selection:text-white">
      <header className="sticky top-0 z-40 border-b border-[#102936]/10 bg-[#F3F0E9]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 md:px-9">
          <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="flex items-center gap-2.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EF5D3F]"><img src="/manus-storage/cosmic-orbit-mark_02e07e29.png" alt="Cosmic orbital C logo" className="h-9 w-9 scale-[1.35] object-cover" /><span className="font-sans text-[10px] font-extrabold tracking-[.3em]">COSMIC</span></button>
          <nav className="hidden items-center gap-6 md:flex"><button onClick={hasChart ? scrollToNatal : requestNatal} className="font-mono text-[9px] tracking-[.14em] text-[#55707d] hover:text-[#EF5D3F]">NATAL CHART</button><Link href="/numerology" className="font-mono text-[9px] tracking-[.14em] text-[#55707d] hover:text-[#EF5D3F]">NUMEROLOGY</Link><Link href="/tarot" className="font-mono text-[9px] tracking-[.14em] text-[#55707d] hover:text-[#EF5D3F]">TAROT</Link><Link href="/palmistry" className="font-mono text-[9px] tracking-[.14em] text-[#55707d] hover:text-[#EF5D3F]">PALMISTRY</Link><Button onClick={openProfile} className="h-10 rounded-none bg-[#211B2A] px-4 font-mono text-[9px] tracking-[.13em] text-white hover:bg-[#EF5D3F]">{profile ? "MY PROFILE" : "CREATE PROFILE"}</Button></nav>
        ...
        {menuOpen && <nav className="border-t border-[#102936]/10 bg-[#F3F0E9] px-5 py-4 md:hidden"><div className="mx-auto grid max-w-7xl gap-2"><button onClick={hasChart ? scrollToNatal : requestNatal} className="flex justify-between border-b border-[#102936]/10 py-3 font-mono text-[10px] tracking-[.14em]">NATAL CHART <ArrowRight size={14} /></button><Link href="/numerology" className="flex justify-between border-b border-[#102936]/10 py-3 font-mono text-[10px] tracking-[.14em]">NUMEROLOGY <ArrowRight size={14} /></Link><Link href="/tarot" className="flex justify-between border-b border-[#102936]/10 py-3 font-mono text-[10px] tracking-[.14em]">TAROT <ArrowRight size={14} /></Link><Link href="/palmistry" className="flex justify-between py-3 font-mono text-[10px] tracking-[.14em]">PALMISTRY <ArrowRight size={14} /></Link><Button onClick={openProfile} className="mt-2 rounded-none bg-[#211B2A] font-mono text-[9px] tracking-[.14em] text-white">{profile ? "MY PROFILE" : "CREATE PROFILE"}</Button></div></nav>}
      </header>
